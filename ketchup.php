 ...
 ?>
	<div class="work-feature-block row">
	      <div class="columns medium-7">
	        <a class="lightbox" href="#ketchup"><img class="work-feature-block-image" src="img/thumbs/ketchupbottle_thumb.jpg" alt="Ketchup bottle Done in Photoshop" /></a>
	      </div>
	      <div class="columns medium-5">
	        <h2 class="work-feature-block-header">Project Description</h2>
	        <p>A digital recreation of a ketchup bottle done in Adobe Photoshop. </p>
